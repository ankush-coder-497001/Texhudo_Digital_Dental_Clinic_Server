...
router.post('/addCategory',authMiddleware(['pharmacist']), medicineController.addCategory);
router.post('/addDistributor', authMiddleware(['pharmacist']), medicineController.addDistributor)
router.get('/getInventory', authMiddleware(['pharmacist']), medicineController.getCombinedInventory)
